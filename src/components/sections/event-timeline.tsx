    ...
    <section className="py-section-mobile md:py-section px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="font-hindi text-2xl text-gold mt-1">शुभ कार्यक्रम</p>
        </div>
        ...
        <div className="relative">
          ...
          <div
            className="absolute top-0 bottom-0 left-4 md:left-1/2 md:-translate-x-1/2 w-0.5 bg-gold"
            aria-hidden="true"
          />
            ...
            {EVENTS.map((event, index) => {
              ...
              return (
                <div key={event.name} className="relative">
                  ...
                  <div
                    className="absolute left-4 md:left-1/2 -translate-x-1/2 top-6 w-4 h-4 rounded-full bg-gold border-2 border-cream z-10"
                    aria-hidden="true"
                  />
                  ...
                  <div className="pl-10 md:pl-0">
                    <ScrollReveal variant={variant}>
                      <EventCard event={event} position={position} />
                    </ScrollReveal>
                  </div>
                </div>
              )
