      ...
      >
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="flex items-center justify-center gap-3 w-full h-14 bg-[#25D366] text-white font-heading text-lg rounded-xl hover:bg-[#22c55e] transition-all shadow-sm"
          >
            <svg
              width="22"
              height="22"
