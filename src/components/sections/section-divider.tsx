...
export function SectionDivider() {
  return (
    <div className="flex items-center justify-center gap-3 py-8 px-4" aria-hidden="true">
      {/* Left gradient line */}
      <div className="h-px flex-1 max-w-[160px] md:max-w-[280px] bg-gradient-to-r from-transparent to-gold" />
      ...
      {/* Right gradient line */}
      <div className="h-px flex-1 max-w-[160px] md:max-w-[280px] bg-gradient-to-l from-transparent to-gold" />
    </div>
  )
}
